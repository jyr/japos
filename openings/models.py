...
class Opening(models.Model):
    ...
    auditor = models.ForeignKey(Employee, related_name = "auditor", verbose_name = _("Auditor"))
    cashier = models.ForeignKey(Employee,related_name = "cashier", verbose_name = _("Cashier"))
